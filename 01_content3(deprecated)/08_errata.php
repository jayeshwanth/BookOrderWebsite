...
.style6 {font-size: 24px; color: #FFCC00; }
.style7 {color: #FF3300}
-->
</style></head>
                  ...
                  <tr>
                    ...
                    <td width="610" align="left" valign="top">
                      <table width="610" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="20" align="left" valign="top"><img src="../02_images/pic_sys/one_pix.gif" alt="" width="20" height="60" /></td>
                          <td width="590" align="left" valign="top"><img src="../02_images/pic_sys/one_pix.gif" alt="" width="590" height="60" /></td>
                        </tr>
                        <tr>
                          <td width="20" align="left" valign="top">&nbsp;</td>
                          <td width="590" align="center" valign="middle">
                          <!-- content starts here -->
                          <p class="style2">Problem 79<br />
                              <br />
                               <span class="style2">"Oppenheimer" should be "Oppenauer"</span>&quot;<br />
                              <br />
                                <br />
                                <p class="style2">p 484<br />
                              <br />
                                <span class="style2">B should be negative not positive</span><br />
                              <br />
                                 <p class="style2">p 540<br />
                              <br />
                               <span class="style2">problem should read "epoxide" not "peroxide"</span><br />
                              <br />
                          </p>
                          <br>
