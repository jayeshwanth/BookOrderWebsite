                      ...
                      <table width="610" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="590" align="left" valign="top"><table width="590" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="120" align="left" valign="top"><img src="../02_images/pictures/authir_pic2.jpg" alt="Kevin" width="120" height="160" /></td>
                              <td width="20" align="left" valign="top">&nbsp;</td>
                              <td width="450" align="left" valign="top">
                              <!-- content starts here -->
                              <span class="menuHead style2">Kevin Burgess</span><span class="style1"> <br />
                              <br />
                              is Rachal Professor of </span><span class="activetext style3"><a href="http://www.chem.tamu.edu/faculty/faculty_detail.php?ID=79" target="_blank">Organic Chemistry at Texas A&M University</a></span><span class="style1">. <br />
                          <br />
                          His research interests focus on synthesis and synthetic methodology to tackle problems of relevance to medicinal chemistry and biotechnology.  Currently, active projects in his research group include:</span>

                              <br />
                              <br />
                          <br /><blockquote>
                          <span class="style4">•      syntheses, mediated by organometallic catalysts, of privileged chirons found in natural products; <br />
                          <br />
                          •      syntheses of dipeptide mimics of secondary structures found at hot-spots in protein-protein interactions; <br />
                          <br />
                          •      construction of combinatorial libraries of molecules designed to disrupt or mimic protein-protein interactions; and, <br />
                          <br />
                          •      syntheses of fluorescent through-bond-energy-transfer cassettes to facilitate observation of protein-protein interactions in cells</span>.</blockquote>

                          <br />
                          <br />
                          <br />
                          <blockquote><a href="http://www.chem.tamu.edu/rgroup/burgess" target="_blank">Kevin Burgess' Research Group</a> </blockquote>
                          <!-- end of content -->                              </td>
                            </tr>
                            <tr>
