...
This is a self-study guide for organic synthesis.  <br />

<br />

It is approximately 600 pages long, with nearly 300 questions and answers illustrated in color.

Problems and solutions are presented to cover some of the most common reactions in contemporary organic chemistry.<br />

<br />  

The content is for first year graduate students and advanced undergraduates taking courses on synthetic reactions.  It focuses on concepts involving conformational, stereochemical, and electronic issues that are by-passed in lower level courses where organic reactions are often presented as generalities in only two dimensions.

<br />

<br />

Based on the premise of questioning to learn, the book presents problems on each right-hand page with a box into which answers can be drawn.  <br />

<br />

A solution to each problem is given on the following left-hand page.  Readers should attempt to solve each problem, and write in their answer, before turning the page to see the solution.
...
Preview select questions and answers <a href="../uploads/illustrative problems.pdf" target="_blank">here in PDF</a> format                    </span><br>
